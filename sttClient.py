...
class Utils:
   ...
   def getAuthenticationToken(hostname, serviceName, username, password):
      ...
      print uri
      resp = requests.get(uri, auth="apikey:-2mECujl3s7Q-CZpnvg6UfkUBSdggFrjg-VpamofvJ6Y", verify=False, headers= {'Accept': 'application/json'},
                          timeout= (30, 30))
      print resp.text
...
if __name__ == '__main__':
   ...
   hostname = "gateway-syd.watsonplatform.net"
   ...
   if args.tokenauth:
      ...
      auth = "apikey:VLHpm6AxZr9XJyAfifoXT-gBI-vC8kKw0IHunvSF7Q6K"
